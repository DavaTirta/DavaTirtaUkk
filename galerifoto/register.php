...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">>
  <div class="container-fluid">
    ...
    collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="
                ...
                <div class="card-body bg-light">
                    ...
                    <form action="config/aksi_register.php" method="POST">
                        ...
                        <div class="d-grid mt-2">
                            <button class="btn btn-primary mt-2 " type="submit" name="kirim">Daftar
                            </button>
                        </div>
                    </form>
                    <hr>
...
<footer class="d-flek justify-content-center border-top mt-3 bg-light fixed-bottom">
    <p>UKK RPL || Dava Tirta Ananta</p>
</footer>
